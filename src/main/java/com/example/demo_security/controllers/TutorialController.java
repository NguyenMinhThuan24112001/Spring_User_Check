...
import com.example.demo_security.repository.TutorialRepository;
...
public class TutorialController {
    ...
    private Sort.Direction getSortDirection(String direction) {
        if (direction.equals("asc")) {//tăng dần
            return Sort.Direction.ASC;
        } else if (direction.equals("desc")) {//giảm dần
    ...
    public ResponseEntity<List<Tutorial>> getAllTutorials(@RequestParam(defaultValue = "id,asc") String[] sort) {
